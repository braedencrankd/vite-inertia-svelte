<script lang="ts">
    import LaravelLogo from "@/views/components/laravel-logo.svelte";
    import InertiaLogo from "@/views/components/inertia-logo.svelte";
    import ResourceBlock from "@/views/components/resource-block.svelte";
